...
\listingsettings
    ...
    \begin{abstract}
        Das Ziel der Arbeit liegt darin, einen Datengenerator für realitätsnahe Daten mit einem Bias beinhaltend zu entwickeln. Diese Daten sollen in der Lehre verwendet werden, um über Bias in Daten aufzuklären. Daher liegt ein weiteres Ziel darin, eine visuelle Auswertung für die generierten Daten zu erstellen, um den Bias in diesen zu veranschaulichen. Das Ergebnis der Arbeit ist eine erfolgreiche Umsetzung zweier realitätsnaher Datengeneratoren für Daten mit einem flexibel wählbaren Bias. Zusätzlich wurden erfolgreich zwei visuelle Datenauswertungen zur Veranschaulichung eines Bias in einem Beispiel Datensatz erstellt.
        \thispagestyle{empty}
    \end{abstract}
    \phantomsection
    %%% ENDE ABSTRACT
