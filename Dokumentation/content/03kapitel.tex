...
%Neben dieser detaillierten Auswertung zur Überprüfung eines Label Bias im Attribut Hautfarbe wurde eine ähnliche nach dem gleichen Prinzip aufgebaute Auswertung zur Überprüfung eines Label Bias im Attribut Geschlecht erstellt.\\
...
Sz1: Bias durch Abwesenheit kein Attribut gefunden womit eine Verzerrung rückführbar wäre. 
Sz2: Auffällig aufgrund von gewissen Attributen. 
...
\begin{table}[h]
    ...
    \multicolumn{1}{|c|}{\begin{tabular}[c]{@{}c@{}}Erstellung einer Auswertung\\ zur Veranschaulichung des Bias\end{tabular}}                        & Visuelle Auswertung in Tableau                                                                                & 80\%               \\ \hline
    \end{tabular}
