...
Zuerst Diagramm der Allgemeinen Verteilung wie sich diese darstellt und erklären.\\
Dann kann ein Attribut ausgewählt werden welches vielleicht diskriminiert wird beginn z.B. mit der Hautfarbe.
Dann Tableau von Hautfarbe\_3 daran sagen hier ist vielleicht was faul und das dies nun auf die anderen überprüft werden muss.
Dann ein Attribut in Verbindung setzen z.B. die Härte des Vergehens mit zusammen Spiel der Hautfarbe. Dafür Tableau Hautfarbe\_4oder5\\
Dann hier die Zusammenhänge erklären und das es nicht daran liegt.\\
Dann noch die Laufende Strafe muss noch angeschaut werden. Hierfür Tableau Hautfarbe\_6oder7 verwenden.\\
Dieses erklären das hier keine negative Auswirkung herrscht.\\
Zum Schluss noch Anzahl Männlich Weibliche Schwarze und Weise prüfen, dass nicht nur schwarze oder nur weiße gibt.\\
Wenn dies fertig sagen dann ist Bias auf Hautfarbe Schwarz.\\
Dann noch sagen diese Untersuchung ist auch noch aufs Geschlecht vorhanden.\\
