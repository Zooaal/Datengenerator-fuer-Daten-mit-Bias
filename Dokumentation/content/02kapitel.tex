    ...
    \label{subsubsec:datenqualität}
        ...
        \begin{table}[h]
            ...
            Representational &  \begin{tabular}[c]{@{}l@{}}
                                    ...
                                    Konsistaent sind und  Manipulierbarkeit, also Veränderbar sind. \\
                                    \cite{Byabazaire2020}
...
%%#########################################
    ...
    \label{subsubsec:KIAllgemein}
        ...
        \\
        \cite{Gröger2021}\cite{Lis2019}\cite{HEGKI2019Definition}\cite{Datenkommission2019}
